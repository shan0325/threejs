...
export class LoadObj {
    ...
    setupLightPositionRatio(model) {
        ...
        this.setupDirectionalLight(box.min.x * 2, sizeBox + box.max.y, box.max.z * 2, 0.5);
        this.setupDirectionalLight(box.max.x * 2, sizeBox * -1, box.max.z * 2, 0.5);
